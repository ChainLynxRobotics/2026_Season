...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
   ...
   * themselves. If they need the devices, they can access them through getters in the classes.
   *
   * @param drivetrainConstants train-wide constants for the swerve drive
    ...
    try {
      ...
      return new FollowPathCommand(
          ...
          new PPHolonomicDriveController( // PPHolonomicController is the built in path following
              ...
              new PIDConstants(3.0, 1.0, 0.0), // Translation PID constants
              new PIDConstants(3.0, 1.0, 0.0) // Rotation PID constants
              ),
  ...
  private void startSimThread() {
    ...
    resetPose(new Pose2d(2, 2, new Rotation2d()));
  ...
  public Pose2d getSimPose() {
    if (mapleSimSwerveDrivetrain == null) return new Pose2d();
